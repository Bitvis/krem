...
def setup_plugins(plugin_handler):
    ...
    plugin_handler.entrypoints["job_configuration"].append_first_to_execute(test_plugins.PluginCalledFirst)
    plugin_handler.entrypoints["job_configuration"].append_first_to_execute(test_plugins.PluginCalledSecond)
    plugin_handler.entrypoints["job_configuration"].append_last_to_execute(test_plugins.PluginCalledThird)
